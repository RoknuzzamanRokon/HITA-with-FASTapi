...
Revision ID: 151aca250ee0
Revises: 5ed44a837cfe
Create Date: 2025-05-07 19:08:59.639813
...
revision: str = '151aca250ee0'
down_revision: Union[str, None] = '5ed44a837cfe'
...
def downgrade() -> None:
    ...
    sa.Column('giver_id', sa.VARCHAR(length=10), nullable=True),
    sa.Column('receiver_id', sa.VARCHAR(length=10), nullable=True),

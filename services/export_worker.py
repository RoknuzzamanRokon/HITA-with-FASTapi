...
class ExportWorker:
        ...
        **kwargs
        ...
        with self.lock:
            ...
            future.add_done_callback(
                lambda f: self._job_completed(job_id)
            )
        ...
        **kwargs
        ...
        try:
            ...
            if export_type == "hotels":
                ...
                include_country_breakdown = query_params.get('filters', {}).get('include_country_breakdown', False)
            ...
            try:
                ...
                logger.error(
                    f"Error updating failed job status: {str(update_error)}"
                )
    ...
    def _rebuild_query(
        ...
        if export_type == "hotels":
            ...
            filters = MappingExportFilters(**query_params.get('filters', {}))

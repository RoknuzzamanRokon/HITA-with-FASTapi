...
async def get_hotel_details(
    ...
    Only works for the first 50 hotels in the demo database.
    """
    try:
        # First, get the first 50 hotel IDs to check if the requested ID is allowed
        first_50_hotels = db.query(models.Hotel.ittid).limit(50).all()
        allowed_hotel_ids = [hotel.ittid for hotel in first_50_hotels]
        
        # Check if the requested hotel_id is in the first 50
